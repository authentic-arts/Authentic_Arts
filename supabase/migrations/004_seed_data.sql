...
-- Description: Seed demo users, artworks, reviews, and analytics.
--   Passwords are managed by Supabase Auth (see README).
--   We insert directly into auth.users and profiles here for
--   local/staging use. In production, use the Supabase dashboard
--   or Auth API to create users, then seed profiles separately.
-- ============================================================

-- ------------------------------------------------------------
-- SEED: auth.users  (fixed UUIDs so foreign keys work)
-- Passwords are all hashed from "artist123" / "user123" / "admin123"
-- In local dev, Supabase accepts plain bcrypt hashes.
-- ------------------------------------------------------------
insert into auth.users (
  ...
  -- Artists
  ('a1000000-0000-0000-0000-000000000001', 'amara@authenticarts.com',
   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh', now(),
   '{"name":"Amara Osei","role":"artist"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  ('a1000000-0000-0000-0000-000000000002', 'kwame@authenticarts.com',
   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh', now(),
   '{"name":"Kwame Mensah","role":"artist"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  ('a1000000-0000-0000-0000-000000000003', 'zara@authenticarts.com',
   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh', now(),
   '{"name":"Zara Ndlovu","role":"artist"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  -- Customers
  ('c1000000-0000-0000-0000-000000000001', 'james@example.com',
   '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', now(),
   '{"name":"James Kariuki","role":"customer"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  ('c1000000-0000-0000-0000-000000000002', 'aisha@example.com',
   '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', now(),
   '{"name":"Aisha Bello","role":"customer"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  ('c1000000-0000-0000-0000-000000000003', 'tendai@example.com',
   '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', now(),
   '{"name":"Tendai Moyo","role":"customer"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  ('c1000000-0000-0000-0000-000000000004', 'fatima@example.com',
   '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', now(),
   '{"name":"Fatima Al-Hassan","role":"customer"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  ('c1000000-0000-0000-0000-000000000005', 'bongani@example.com',
   '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', now(),
   '{"name":"Bongani Dlamini","role":"customer"}'::jsonb, now(), now(), 'authenticated', 'authenticated'),

  -- Admin
  ('ad000000-0000-0000-0000-000000000001', 'admin@authenticarts.com',
   '$2a$10$Xv1l6e.MaFIu2Q/k/0QXKeVGE.s7XHm5sR0tqJUEf7JBl7X9bAEeO', now(),
   '{"name":"Dr. Chioma Eze","role":"admin"}'::jsonb, now(), now(), 'authenticated', 'authenticated')
...
insert into public.profiles (
  ...
  ('a1000000-0000-0000-0000-000000000001','amara@authenticarts.com','Amara Osei','artist',
   ...
   '{Paintings,"Mixed Media"}',true,
   48,124800,18750,106050,3420, 24,18,6, '{}',false),
  ...
  ('a1000000-0000-0000-0000-000000000002','kwame@authenticarts.com','Kwame Mensah','artist',
   ...
   '{Sculptures,"Digital Art"}',true,
   62,198400,22300,176100,5100, 31,25,6, '{}',false),
  ...
  ('a1000000-0000-0000-0000-000000000003','zara@authenticarts.com','Zara Ndlovu','artist',
   ...
   '{Photography,"Mixed Media"}',true,
   35,87500,14200,73300,2780, 18,12,6, '{}',false),
  ...
  ('c1000000-0000-0000-0000-000000000004','fatima@example.com','Fatima Al-Hassan','customer',
   ...
   null,'{}',false, 0,0,0,0,0, 0,0,0,
   '{Sculptures,"Traditional Contemporary"}',true),
...
insert into public.artworks (
  id, artist_id, artist_name, title, description, category, style,
  medium, dimensions, year, origin, authenticity, inspiration,
  tags, alt_text, price, original_price, quantity,
  images, status, featured, best_seller, sales, average_rating, review_count
) values
  ('a0000001-0000-0000-0000-000000000001',
   'a1000000-0000-0000-0000-000000000001','Amara Osei',
   'Golden Horizons',
   'A breathtaking exploration of light and landscape, capturing the moment the African sun meets the earth.',
   'Paintings','Contemporary','Oil on linen canvas','120cm x 90cm',2023,
   'Created in Accra, Ghana. Materials sourced locally. Painted on hand-stretched linen canvas.',
   'Certificate of Authenticity #AA-2023-001. Signed and dated on reverse.',
   'Inspired by early morning walks along the Volta River.',
   '{landscape,light,africa,"oil painting"}',
   'An oil painting titled Golden Horizons featuring a vibrant sunrise over the African landscape.',
   2800,2800,1,
   '{"https://picsum.photos/seed/goldenhorizons/800/600","https://picsum.photos/seed/goldenhorizons2/800/600","https://picsum.photos/seed/goldenhorizons3/800/600"}',
   'available',true,true,0,4.8,12),

  ('a0000001-0000-0000-0000-000000000002',
   'a1000000-0000-0000-0000-000000000001','Amara Osei',
   'Ancestral Echoes',
   'A deeply personal work exploring the connection between present-day Ghanaians and their ancestral heritage.',
   ...
   '{abstract,heritage,symbols,"gold leaf"}',
   'An abstract acrylic painting with gold leaf titled Ancestral Echoes.',
   3500,3500,1,
   '{"https://picsum.photos/seed/ancestral/800/600","https://picsum.photos/seed/ancestral2/800/600"}',
   'available',true,false,0,4.9,8),

  ('a0000001-0000-0000-0000-000000000003',
   'a1000000-0000-0000-0000-000000000002','Kwame Mensah',
   'Urban Rhythms',
   'A dynamic digital composition capturing the energy and chaos of Nairobi''s streets.',
   ...
   '{digital,urban,geometric,nairobi}',
   'A contemporary digital illustration print titled Urban Rhythms.',
   950,950,5,
  ...
  ('a0000001-0000-0000-0000-000000000004',
   'a1000000-0000-0000-0000-000000000002','Kwame Mensah',
   'The Weaver''s Song',
   'A stunning bronze sculpture depicting a woman weaving, celebrating the tradition of African textile arts.',
   ...
   '{sculpture,bronze,weaving,tradition,figurative}',
   'A bronze sculpture with patina titled The Weaver''s Song.',
   6200,6200,1,
   '{"https://picsum.photos/seed/weaversong/800/600","https://picsum.photos/seed/weaversong2/800/600","https://picsum.photos/seed/weaversong3/800/600"}',
   'available',true,true,0,5.0,6),

  ('a0000001-0000-0000-0000-000000000005',
   'a1000000-0000-0000-0000-000000000003','Zara Ndlovu',
   'Solitude in Blue',
   'A hauntingly beautiful photograph of a lone figure against the vast expanse of the Atlantic Ocean.',
   ...
   '{photography,ocean,solitude,blue,"fine art"}',
   'A fine art photograph titled Solitude in Blue showing a lone figure on Cape Town beach.',
   780,780,3,
   '{"https://picsum.photos/seed/solitudeinblue/800/600","https://picsum.photos/seed/solitudeinblue2/800/600"}',
   'available',false,true,2,4.6,9),

  ('a0000001-0000-0000-0000-000000000006',
   'a1000000-0000-0000-0000-000000000003','Zara Ndlovu',
   'Market Day, Lagos',
   'An explosion of colour and life from Lagos''s Balogun Market.',
   ...
   '{photography,market,lagos,documentary,color}',
   'A documentary photograph titled Market Day, Lagos.',
   620,620,5,
   '{"https://picsum.photos/seed/marketday/800/600","https://picsum.photos/seed/marketday2/800/600"}',
   'available',false,false,4,4.5,7),

  ('a0000001-0000-0000-0000-000000000007',
   'a1000000-0000-0000-0000-000000000001','Amara Osei',
   'Fragments of Tomorrow',
   'A large-scale mixed media work combining oil paint, collaged newspaper clippings, and textile fragments.',
   ...
   '{"mixed media",collage,textile,contemporary,africa}',
   'A mixed media artwork titled Fragments of Tomorrow.',
   4100,4100,1,
   '{"https://picsum.photos/seed/fragments/800/600","https://picsum.photos/seed/fragments2/800/600"}',
   'available',false,false,0,4.9,4),

  ('a0000001-0000-0000-0000-000000000008',
   'a1000000-0000-0000-0000-000000000002','Kwame Mensah',
   'Digital Savanna',
   'A mesmerizing digital artwork reimagining the African savanna through a cyberpunk lens.',
   ...
   '{digital,savanna,wildlife,neon,cyberpunk}',
   'A digital artwork print titled Digital Savanna depicting animals in cyberpunk style.',
   1200,1200,10,
   '{"https://picsum.photos/seed/digitalsavanna/800/600","https://picsum.photos/seed/digitalsavanna2/800/600"}',
   'available',false,true,7,4.8,18),

  ('a0000001-0000-0000-0000-000000000009',
   'a1000000-0000-0000-0000-000000000002','Kwame Mensah',
   'Stone Sentinel',
   'A striking minimalist sculpture carved from Kenyan green marble.',
   ...
   '{sculpture,marble,minimalist,stone,kenya}',
   'A minimalist green marble sculpture titled Stone Sentinel.',
   3800,3800,1,
   '{"https://picsum.photos/seed/stonesentinel/800/600","https://picsum.photos/seed/stonesentinel2/800/600"}',
   'available',false,false,0,4.7,3),

  ('a0000001-0000-0000-0000-000000000010',
   'a1000000-0000-0000-0000-000000000003','Zara Ndlovu',
   'Rainforest Dreams',
   'An ethereal long-exposure photograph taken in the Daintree Rainforest.',
   ...
   '{photography,rainforest,nature,"long exposure",mist}',
   'A long-exposure photograph titled Rainforest Dreams capturing misty green trees.',
   890,890,4,
   '{"https://picsum.photos/seed/rainforest/800/600","https://picsum.photos/seed/rainforest2/800/600"}',
   'available',false,false,1,4.8,5),

  ('a0000001-0000-0000-0000-000000000011',
   'a1000000-0000-0000-0000-000000000001','Amara Osei',
   'Fire Dance',
   'An energetic expressionist painting capturing the primal power of a traditional fire dance ceremony.',
   ...
   '{expressionist,fire,dance,ceremony,culture}',
  ...
  ('a0000001-0000-0000-0000-000000000012',
   'a1000000-0000-0000-0000-000000000002','Kwame Mensah',
   'Neon Pulse',
   'A hypnotic digital abstract composition pulsing with neon energy.',
   ...
   '{digital,neon,abstract,neural,AI}',
   'An abstract digital illustration print titled Neon Pulse.',
   750,750,8,
   '{"https://picsum.photos/seed/neonpulse/800/600","https://picsum.photos/seed/neonpulse2/800/600"}',
   'available',false,false,5,4.5,11),

  ('a0000001-0000-0000-0000-000000000013',
   'a1000000-0000-0000-0000-000000000001','Amara Osei',
   'Kente Reimagined',
   'A stunning mixed media work incorporating real strips of Kente cloth woven into the painted surface.',
   ...
   'Honouring the Kente tradition in the contemporary art world.',
   '{"mixed media",kente,textile,ghana,heritage}',
   'A mixed media work titled Kente Reimagined weaving Kente cloth into oil paint.',
   3200,3200,1,
   '{"https://picsum.photos/seed/kente/800/600","https://picsum.photos/seed/kente2/800/600"}',
   'available',false,false,0,4.9,4)
on conflict (id) do nothing;
...
-- SEED: reviews
-- ------------------------------------------------------------
insert into public.reviews (id, artwork_id, user_id, user_name, user_avatar, rating, comment, verified, created_at) values
  ('e0000001-0000-0000-0000-000000000001',
   'a0000001-0000-0000-0000-000000000001',
   'c1000000-0000-0000-0000-000000000001','James Kariuki',
   'https://picsum.photos/seed/james/200/200',
   5,'Absolutely magnificent. The gold tones are even more stunning in person.',true,'2023-09-15'),

  ('e0000001-0000-0000-0000-000000000002',
   'a0000001-0000-0000-0000-000000000001',
   'c1000000-0000-0000-0000-000000000002','Aisha Bello',
   'https://picsum.photos/seed/aisha/200/200',
   5,'Amara''s work is unparalleled. This painting now hangs in my living room.',true,'2023-10-02'),

  ('e0000001-0000-0000-0000-000000000003',
   'a0000001-0000-0000-0000-000000000001',
   'c1000000-0000-0000-0000-000000000003','Tendai Moyo',
   'https://picsum.photos/seed/tendai/200/200',
  ...
  ('e0000001-0000-0000-0000-000000000008',
   'a0000001-0000-0000-0000-000000000008',
   'c1000000-0000-0000-0000-000000000005','Bongani Dlamini',
   'https://picsum.photos/seed/bongani/200/200',
...
-- ------------------------------------------------------------
-- SEED: purchased_artworks  (reflects mockData purchasedArtworks)
-- We create placeholder orders to satisfy the FK constraint.
-- ------------------------------------------------------------
insert into public.orders (id, customer_id, status, payment_method, subtotal, total, first_time_discount_applied, created_at)
values
  ('0d000001-0000-0000-0000-000000000001','c1000000-0000-0000-0000-000000000001','delivered','mpesa',1900,1900,false,'2023-08-01'),
  ('0d000001-0000-0000-0000-000000000002','c1000000-0000-0000-0000-000000000002','delivered','paypal',1400,1400,false,'2023-07-01'),
  ('0d000001-0000-0000-0000-000000000003','c1000000-0000-0000-0000-000000000003','delivered','mpesa',2200,2200,false,'2023-10-01'),
  ('0d000001-0000-0000-0000-000000000004','c1000000-0000-0000-0000-000000000005','delivered','paypal',750,750,false,'2023-10-20')
on conflict (id) do nothing;

insert into public.purchased_artworks (customer_id, artwork_id, order_id, purchased_at) values
...
-- ------------------------------------------------------------
-- SEED: sales_analytics  (12-month data per artist from mockData)
-- ------------------------------------------------------------
